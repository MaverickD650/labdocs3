...
---
Pure and simple I started this site to document my setup, tempt employers and try a cool method of deploying a site. Currently I use Cloudflare Pages to host the site and Github actions to build and deploy the site. I use [Starlight](https://starlight.astro.build/) to build the site and currently edit it with [VSCode](https://code.visualstudio.com/).
